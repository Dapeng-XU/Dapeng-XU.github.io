...
\begin{frame}{Demo: Gabow's biconnected components algorithm}
	...
	\begin{itemize}
		\begin{overlayarea}{\textwidth}{\textheight}
			...
			\only<3>{\item Procedure: DFS(2): w=3{\item $P=\{\, v_1,\,\{v_1,\,v_2\},\,v_2,\,\{v_2,\,v_3\} \,\}$}}
			\only<4>{\item Procedure: DFS(3): w=1{\item $P=\{\, v_1,\,\{v_1,\,v_2,\,v_3\} \,\}$}}
			\only<5>{\item Procedure: DFS(3): w=4{\item $P=\{\, v_1,\,\{v_1,\,v_2,\,v_3\},\,v_3,\,\{v_3,\,v_4\} \,\}$}}
			\only<6>{\item Procedure: DFS(4): w=2{\item $P=\{\, v_1,\,\{v_1,\,v_2,\,v_3,\,v_4\} \,\}$}}
			\only<7>{\item Procedure: DFS(4): w=5{\item $P=\{\, v_1,\,\{v_1,\,v_2,\,v_3,\,v_4\},\,v_4,\,\{v_4,v_5\} \,\}$}}
			\only<8>{\item Procedure: DFS(5): w=3{\item $P=\{\, v_1,\,\{v_1,\,v_2,\,v_3,\,v_4,\,v_5\} \,\}$}}
			\only<9>{\item Procedure: DFS(5): w=6{\item $P=\{\, v_1,\,\{v_1,\,v_2,\,v_3,\,v_4,\,v_5\},\,v_5,\,\{v_5,\,v_6\} \,\}$}}
			\only<10>{\item Procedure: DFS(6): w=7{\item $P=\{\, v_1,\,\{v_1,\,v_2,\,v_3,\,v_4,\,v_5\},\,v_5,\,\{v_5,\,v_6\},\,v_6,\,\{v_6,\,v_7\} \,\}$}}
			\only<11>{\item Procedure: DFS(7): w=5{\item $P=\{\, v_1,\,\{v_1,\,v_2,\,v_3,\,v_4,\,v_5\},\,v_5,\,\{v_5,\,v_6,\,v_7\} \,\}$}}
			\only<12>{\item Procedure: DFS(7): End{\item $P=\{\, v_1,\,\{v_1,\,v_2,\,v_3,\,v_4,\,v_5\},\,v_5,\,\{v_5,\,v_6,\,v_7\} \,\}$}}
			\only<13>{\item Procedure: DFS(6): End{\item $P=\{\, v_1,\,\{v_1,\,v_2,\,v_3,\,v_4,\,v_5\} \,\} \quad \{v_5,\,v_6,\,v_7\}$}}
			\only<14>{\item Procedure: DFS(5): End(No operation when w=7){\item $P=\{\, v_1,\,\{v_1,\,v_2,\,v_3,\,v_4,\,v_5\} \,\} \quad \{v_5,\,v_6,\,v_7\}$}}
			\only<15>{\item Procedure: DFS(4): End{\item $P=\{\, v_1,\,\{v_1,\,v_2,\,v_3,\,v_4,\,v_5\} \,\} \quad \{v_5,\,v_6,\,v_7\}$}}
			\only<16>{\item Procedure: DFS(3): End(No operation when w=5){\item $P=\{\, v_1,\,\{v_1,\,v_2,\,v_3,\,v_4,\,v_5\} \,\} \quad \{v_5,\,v_6,\,v_7\}$}}
			\only<17>{\item Procedure: DFS(2): End{\item $P=\{\, \,\} \quad \{v_1,\,v_2,\,v_3,\,v_4,\,v_5\} \quad \{v_5,\,v_6,\,v_7\}$}}
			\only<18>{\item Procedure: DFS(1): End{\item $P=\{\, \,\} \quad \{v_1,\,v_2,\,v_3,\,v_4,\,v_5\} \quad \{v_5,\,v_6,\,v_7\}$}}
		\end{overlayarea}
	\end{itemize}
\end{frame}
