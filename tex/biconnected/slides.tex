...
\begin{frame}{Purdom and Munro's High-Level Algorithm: Plain text}
	\begin{itemize}
		\item
		If H has no vertices stop. Otherwise \emph{start a new path $P$} by choosing a vertex $v$ and
		setting $P=(v)$. Continue by growing $P$ as follows.
		\item
...
\begin{frame}{A simple example}
	...
	\begin{itemize}
		...
		\item
		For nodes in strong components $(v_r,\,\cdots,\,v_s,\,\cdots,\,v_t)$, they will be
		not deleted(but be contracted first) until the Sub-DFS() on $v_r$ is finished.
	\end{itemize}
\end{frame}
